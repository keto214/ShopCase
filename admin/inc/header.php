        ...
        <div class="grid_12 header-repeat">
            <div id="branding">
                <div class="floatleft" style="width: 100px;">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvdBkO_h0d2o0m69KT2Tz7Ubq06UHBEyCvGw&usqp=CAU" width="100%" alt="Logo" />
				</div>
				<div class="floatleft middle">
					<h1 style="padding: 10px 0px 0px 0px;">WELCOME TO In4 TEAM</h1>
				</div>
                <div class="floatright">
                    ...
                    <div class="floatleft marginleft10">
                        <ul class="inline-ul floatleft" style="font-size: 18px;">
                            <li>Xin chào <?php echo Session::get('name') ?></li>
                            <?php 
